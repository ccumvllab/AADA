...
class EncoderDecoder(BaseSegmentor):
    ...
    def forward_cross(self, x, y, cross_layer):
        """cross attention from source and target."""
        if cross_layer==1:
            return self.backbone.forward_cross_1(x, y)
        elif cross_layer==2:
            return self.backbone.forward_cross_2(x, y)
        elif cross_layer==3:
            return self.backbone.forward_cross_3(x, y)
        elif cross_layer==4:
            return self.backbone.forward_cross_4(x, y)
